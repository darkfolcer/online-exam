    ...
    <div id="content">
                        <div class="container">
                            <div class="row margin-vert-30">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BilalConnectionString %>" SelectCommand="SELECT Instructor.instructorID, Person.username, Person.name, Person.lastname, Person.role,Person.email,Instructor.isApproved FROM Person INNER JOIN Instructor ON Person.username = Instructor.username WHERE (Instructor.isApproved = 0)"></asp:SqlDataSource>
                                <asp:GridView ID="GridView1" CssClass="table table-bordered table-hover table-condensed" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="username" DataSourceID="SqlDataSource1" AllowSorting="True" OnRowCommand="GridView1_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:ButtonField HeaderText="Approve" ControlStyle-CssClass="btn btn-success" CommandName="ID" SortExpression="isApproved" ButtonType="Button" Text="Accept"/>
                                        <asp:ButtonField ButtonType="Button" ControlStyle-CssClass="btn btn-danger" CommandName="Reject" HeaderText="Reject" Text="Reject" />
                                    </Columns>
                                    <EmptyDataTemplate>
